 ...
 *
 * item：对 bindingVariable、layoutRes 管理
 */
...
public final class ItemView {
     ...
     *
     * @see #setBindingVariable(int) binding值
     * @see #setLayoutRes(int) 布局文件
     */
    public static ItemView of(int bindingVariable, @LayoutRes int layoutRes) {
        return new ItemView()
                .setBindingVariable(bindingVariable)// 设置变量
                .setLayoutRes(layoutRes);// 设置变量
    }

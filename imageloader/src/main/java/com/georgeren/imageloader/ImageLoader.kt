package com.georgeren.imageloader
...
object ImageLoader {
    ...
    fun loadImage(imageView: ImageView, url: String?, placeholderRes: Int?, callback: Callback? = null) {
        ...
        imageView.setImageResource(placeholderRes ?: 0) // 加载默认图片: placeholderRes ?: 0 如果placeholderRes=null则--》placeholderRes=0
    ...
    private fun isValid(context: Context, url: String?): Boolean {
        if (context is Activity) {// 判断activity是否已经销毁了
